...
def get_complex_output_parser():
    response_schemas = [
        ...
        ResponseSchema(name="is_family_friendly", description="Is the movie family-friendly? True or False"),
        ResponseSchema(name="genre", description="Genre of the movie"),
        ResponseSchema(name="run_time", description="Run time of the movie"),
        ResponseSchema(name="year_released", description="Year the movie was released")
    ]
