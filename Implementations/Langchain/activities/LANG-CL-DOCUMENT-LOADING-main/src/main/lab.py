...
loader = TextLoader("D:/Revature Training/Daily Workspaces/7thFeb/activities/LANG-CL-DOCUMENT-LOADING-main/src/resources/lab_docs/simple_text.txt")
doc = loader.load()
print(doc)
...
"""
loader = DirectoryLoader("D:/Revature Training/Daily Workspaces/7thFeb/activities/LANG-CL-DOCUMENT-LOADING-main/src/resources/genres_organized", show_progress=True, loader_cls=CSVLoader, glob="**/*.csv")
docs = loader.load()
print(docs, end="\n\n")
